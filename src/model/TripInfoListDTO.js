(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ObjectError', 'model/TripInfoDTO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ObjectError'), require('./TripInfoDTO'));
  } else {
    // Browser globals (root is window)
    if (!root.ContiEdge) {
      root.ContiEdge = {};
    }
    root.ContiEdge.TripInfoListDTO = factory(root.ContiEdge.ApiClient, root.ContiEdge.ObjectError, root.ContiEdge.TripInfoDTO);
  }
}(this, function(ApiClient, ObjectError, TripInfoDTO) {
  'use strict';
  ...
  /**
   * The TripInfoListDTO model module.
   * @module model/TripInfoListDTO
   * @version 1.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>TripInfoListDTO</code>.
   * @alias module:model/TripInfoListDTO
   * @class
   */
  ...
  /**
   * Constructs a <code>TripInfoListDTO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TripInfoListDTO} obj Optional instance to populate.
   * @return {module:model/TripInfoListDTO} The populated <code>TripInfoListDTO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tripInfoDTOList')) {
        obj['tripInfoDTOList'] = ApiClient.convertToType(data['tripInfoDTOList'], [TripInfoDTO]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/TripInfoDTO>} tripInfoDTOList
   */
  exports.prototype['tripInfoDTOList'] = undefined;
