(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ContiEdge.ManagedUserDTO = factory(root.ContiEdge.ApiClient);
  }
  ...
  /**
   * The ManagedUserDTO model module.
   * @module model/ManagedUserDTO
   * @version 1.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>ManagedUserDTO</code>.
   * @alias module:model/ManagedUserDTO
   * @class
   */
  ...
  /**
   * Constructs a <code>ManagedUserDTO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ManagedUserDTO} obj Optional instance to populate.
   * @return {module:model/ManagedUserDTO} The populated <code>ManagedUserDTO</code> instance.
   */
