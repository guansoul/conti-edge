(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ContiEdge.LaunchAdvertisingPageDTO = factory(root.ContiEdge.ApiClient, root.ContiEdge.ObjectError);
  }
  ...
  /**
   * The LaunchAdvertisingPageDTO model module.
   * @module model/LaunchAdvertisingPageDTO
   * @version 1.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>LaunchAdvertisingPageDTO</code>.
   * @alias module:model/LaunchAdvertisingPageDTO
   * @class
   */
  ...
  /**
   * Constructs a <code>LaunchAdvertisingPageDTO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LaunchAdvertisingPageDTO} obj Optional instance to populate.
   * @return {module:model/LaunchAdvertisingPageDTO} The populated <code>LaunchAdvertisingPageDTO</code> instance.
   */
