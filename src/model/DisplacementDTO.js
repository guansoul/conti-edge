(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ContiEdge.DisplacementDTO = factory(root.ContiEdge.ApiClient, root.ContiEdge.ObjectError);
  }
  ...
  /**
   * The DisplacementDTO model module.
   * @module model/DisplacementDTO
   * @version 1.2-SNAPSHOT
   */

  /**
   * Constructs a new <code>DisplacementDTO</code>.
   * @alias module:model/DisplacementDTO
   * @class
   */
  ...
  /**
   * Constructs a <code>DisplacementDTO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DisplacementDTO} obj Optional instance to populate.
   * @return {module:model/DisplacementDTO} The populated <code>DisplacementDTO</code> instance.
   */
